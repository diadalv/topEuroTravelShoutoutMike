...
const registerServices: RegisterService[] = [
  ...
  },
  {
    ...
    imageAlt: 'Travel support specialist assisting a guest by phone',
  },
  {
    number: '05',
  ...
  },
  {
    ...
    imageAlt: 'Elegant dinner event arranged for groups and incentives',
  },
  {
    number: '07',
    title: 'Weddings',
    ...
    imageAlt: 'Beach wedding ceremony setup in Greece',
  },
  {
    number: '08',
    ...
    imageAlt: 'Desk with laptop for agent portal and connectivity services',
  },
];
